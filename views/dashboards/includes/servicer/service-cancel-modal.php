...
<div class="modal fade" id="ServiceCancel" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered justify-content-center">
            <div class="modal-content" style="padding: 0;">
                ...
                <div class="modal-body">
                    <form action="<?=Config::BASE_URL."?controller=SDashboard&function=CancelService"?>" method="POST" id="form-service-cancel">
